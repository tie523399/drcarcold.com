...
async function main() {
  ...
  const news = await Promise.all([
    ...
    prisma.news.create({
      data: {
        title: '車輛冷媒系統保養指南',
        slug: '20-u-carlikelikelikelike-24401053',
        content: `車輛空調系統的冷媒是確保夏季舒適駕駛的關鍵因素。定期檢查和維護冷媒系統不僅能提升空調效能，還能延長設備壽命。本文將為您詳細介紹汽車冷媒系統的保養要點...
...
建議每年春季進行一次全面的冷媒系統檢查，確保夏季使用時的最佳效果。如有任何問題，請聯繫車冷博士專業團隊。`,
        excerpt: '完整的車輛冷媒系統保養指南，包含檢查要點、常見問題及解決方案',
        author: '技術團隊',
